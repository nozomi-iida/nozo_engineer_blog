...
export class TagServiceClient {
  ...
  getTags(
    ...
    callback: (error: ServiceError|null, responseMessage: public_v1_tag_service_pb.GetTagsResponse|null) => void
  ): UnaryResponse;
  getTags(
    requestMessage: public_v1_tag_service_pb.GetTagsRequest,
    callback: (error: ServiceError|null, responseMessage: public_v1_tag_service_pb.GetTagsResponse|null) => void
  ...
  getTag(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: public_v1_tag_service_pb.GetTagResponse|null) => void
  ): UnaryResponse;
  getTag(
    requestMessage: public_v1_tag_service_pb.GetTagRequest,
    callback: (error: ServiceError|null, responseMessage: public_v1_tag_service_pb.GetTagResponse|null) => void
